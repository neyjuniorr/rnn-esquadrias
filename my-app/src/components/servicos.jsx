  ...
  return (
    <div name="Serviços" className="w-full min-h-screen bg-blue-900">
      <div className="max-w-screen p-7 flex flex-col lg:flex-row justify-center w-full h-full">
        ...
        <div name="Entre em contato" className="lg:w-3/6 p-5 border-t-8 mt-16">
          <h2 className="text-3xl font-bold text-white">Solicite um Orçamento</h2>
          
          <p className="text-white mt-10">
            Entre em contato conosco para obter um orçamento personalizado para as esquadrias de alumínio sob medida.
          </p>
          <ul className="text-white mt-5">
            <a href="https://wa.me/5561999971128" className='flex items-center' target='blanck'>
            <li>
              <FiPhone className="inline text-xl mr-2" color='green' />
              61 99997-1128
            </li>
            </a>
            <a href="mailto:rnnesquadrias@gmail.com" className="flex items-center" target='blanck'>
            <li>
              <FiMail className="inline text-xl mr-2" />
            ...
            <li>
              <FaMapMarker className="inline text-xl mr-2" />
              QR 501 Conjunto 10 Lote 11  Samambaia/DF
            </li>
            </a>
            <a href="https://www.instagram.com/rnn.esquadrias/" target='blanck'>
            <li>
              <FiInstagram className="inline text-xl mr-2" color='pink'/>
              https://www.instagram.com/rnn.esquadrias/
            </li>
            </a>
            <li>
                <h2 className='mt-10'>Horário de funcionamento: <br></br>
                    Segunda a sexta 
                    07h00 as 17h00 
                </h2>
            </li>
            <img src={Image} alt="logo final" width={160} />
          </ul>
          </div>
        </div>
      </div>
